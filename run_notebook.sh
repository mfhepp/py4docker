...
echo "WARNING: Outbound network ENABLED (Warning: The notebook and all components can access the entire host network)"
# Open browser
...
# read-only file system does not seem to work for Jupyter kernels
